 ...
 *
 * \brief This file defines an output array transformation template for not
 *        transforming the output array of a data stream operation at all.
 *
...
struct none
  : none_base<MappingModel::in_arity, MappingModel>
{
  ...
  : out_arr_transform_selector_type
{
    ...
    {
        typedef detail::none<MappingModel>
                type;
    };
};
