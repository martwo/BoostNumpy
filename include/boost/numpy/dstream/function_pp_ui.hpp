 ...
 *
 * \file    boost/numpy/dstream/function_pp_ui.hpp
 * \version $Revision$
 * \date    $Date$
 * \author  Martin Wolf <martin.wolf@icecube.wisc.edu>
 *
 * \brief This file defines pre-processor macros for a nicer user interface to
 *        the dstream templates for exposing functions to Python having numpy
 *        array support.
 *
 ...
 */
#ifndef BOOST_NUMPY_DSTREAM_FUNCTION_PP_UI_HPP_INCLUDED
#define BOOST_NUMPY_DSTREAM_FUNCTION_PP_UI_HPP_INCLUDED
 ...
 *     boost::python::def for exposing functions to Python.
 *     It can be used as so:
 *     \code
 *     boost::python::def(BOOST_NUMPY_DSTREAM_FUNCTION_ADVANCED(
 *           (m)(y)(_)(f)(u)(n)(c)
 *         , TheMappingModel
 *         , TheWiringModel
 *         , (setting1)(setting2)(...)
 ...
 *     \endcode
 */
#define BOOST_NUMPY_DSTREAM_FUNCTION_ADVANCED(                                 \
      _func_name_seq                                                           \
    , _mapping_model                                                           \
    , _wiring_model                                                            \
    , _cfg_setting_seq                                                         \
 ...
 *     BOOST_NUMPY_DSTREAM_FUNCTION_ADVANCED macro.
 ...
 *     It can be used as so:
 *     \code
 *     boost::python::def(BOOST_NUMPY_DSTREAM_FUNCTION(
 *           (m)(y)(_)(f)(u)(n)(c)
 *         , TheMappingModel
 *         , TheWiringModel
 *         , (setting1)(setting2)(...)
 ...
 *     \endcode
 */
#define BOOST_NUMPY_DSTREAM_FUNCTION(                                          \
      _func_name_seq                                                           \
    , _mapping_model                                                           \
    , _wiring_model                                                            \
    , _cfg_setting_seq                                                         \
    ...
    , _out_name ,_in_name_seq)                                                 \
                                                                               \
    BOOST_NUMPY_DSTREAM_FUNCTION_ADVANCED(                                     \
          _func_name_seq                                                       \
        , _mapping_model                                                       \
        , _wiring_model                                                        \
        , _cfg_setting_seq                                                     \
...
#endif // !BOOST_NUMPY_DSTREAM_FUNCTION_PP_UI_HPP_INCLUDED
